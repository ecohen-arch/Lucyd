# Gorgias Help Center Articles

Copy each article into Gorgias Help Center. Format is ready for direct paste.

---

## Category 1: 🚀 Getting Started

### Article 1.1: First-Time Setup Guide

**Title:** First-Time Setup Guide
**Category:** Getting Started
**Tags:** setup, unboxing, start
...
Connect the magnetic charging cable to the temples. The LED will light up:
- Red = Charging
- Green = Fully charged
...
Press and hold the button on either temple for 2 seconds.

**Step 3: Pair with Phone**

1. Make sure Bluetooth is ON on your phone
2. On your glasses, hold the button for 5 seconds until you hear "pairing mode"
3. Find "Lucyd" in your phone's Bluetooth settings
4. Tap to connect - you'll hear "connected"

**Step 4: Download the Lucyd App**

Get the Lucyd app from the App Store (iPhone) or Google Play (Android) for:
- Firmware updates
...
Play music, take calls, or activate your voice assistant. Tap the temples to control playback.

---

### Article 1.2: Bluetooth Pairing Guide

**Title:** Bluetooth Pairing Guide
**Category:** Getting Started
**Tags:** bluetooth, pairing, connect

---

**First-Time Pairing**

1. Turn on your glasses (hold button 2 seconds)
2. Enter pairing mode (hold button 5 seconds) - you'll hear "pairing mode"
3. On your phone:
   - iPhone: Settings → Bluetooth → Select "Lucyd"
   - Android: Settings → Connections → Bluetooth → "Lucyd"
4. You'll hear "connected" when successful

**Automatic Reconnection**

After first pairing, your glasses will automatically connect when:
- Turned on near your paired phone
- Your phone's Bluetooth is enabled

**Pairing to a New Device**

1. On your old device, go to Bluetooth settings and "Forget" Lucyd
2. Put your glasses in pairing mode (hold button 5 seconds)
3. Select "Lucyd" on your new device
...
### Article 1.3: Lucyd App Setup

**Title:** Lucyd App Setup Guide
**Category:** Getting Started
**Tags:** app, download, setup
...
4. Tap "Add Device" in the app
5. Select your Lucyd glasses from the list
...
**PD Measurement**
- Measure pupillary distance with camera
...
### Article 1.4: Touch Controls Guide

**Title:** Touch Controls Guide
**Category:** Getting Started
**Tags:** controls, gestures, touch

---

**Right Temple Controls**
...
**Left Temple Controls**

| Gesture | Action |
|---------|--------|
| Single Tap | Answer/End Call |
| Double Tap | Reject Call |
| Tap & Hold | Voice Assistant |
| Long Hold (2 sec) | Volume Down |

**Both Temples**

| Gesture | Action |
|---------|--------|
| Hold 2 seconds | Power On/Off |
| Hold 10 seconds | Factory Reset |

**Tips for Best Results**

- Tap firmly on the temple, not the frame
- Wait 1 second between gestures
- Customize controls in the Lucyd app

---

## Category 2: 🔧 Troubleshooting

### Article 2.1: Bluetooth Won't Connect

**Title:** Bluetooth Won't Connect
**Category:** Troubleshooting
**Tags:** bluetooth, connection, pairing, troubleshoot
...
- [ ] Glasses charged (20%+ recommended)
- [ ] Within 10 feet of phone

**Step 1: Forget & Re-pair**

1. Go to phone Bluetooth settings
2. Find "Lucyd" and tap "Forget" or "Unpair"
3. Turn off glasses (hold button 2 sec)
4. Turn on and enter pairing mode (hold 5 sec)
5. Select "Lucyd" in phone Bluetooth

**Step 2: Restart Phone**

A full restart can clear Bluetooth glitches.

**Step 3: Factory Reset Glasses**

Hold BOTH temple buttons for 10 seconds until you hear a tone. Re-pair from scratch after reset.
...
### Article 2.2: No Audio / Sound Issues

**Title:** No Audio / Sound Issues
**Category:** Troubleshooting
**Tags:** audio, sound, volume, troubleshoot

---

**Quick Checks**

- [ ] Phone media volume turned up (not just ringer)
- [ ] Glasses volume up (tap right temple)
- [ ] Audio output set to "Lucyd" on phone
- [ ] Glasses connected via Bluetooth

**No Sound At All**

1. Verify Bluetooth connection
2. Play audio from different app
3. Check "Audio Output" in phone settings
4. Factory reset (hold BOTH buttons 10 sec)
5. Re-pair with phone

**Sound Cutting Out**

- Move closer to phone (within 30 feet)
- Remove obstructions between glasses and phone
- Check for WiFi/Bluetooth interference
- Update firmware via Lucyd app

**Sound Quality Issues**

- Crackling → Check Bluetooth range
- Quiet → Increase both phone AND glasses volume
- Distorted → Update firmware, try reset

**One Side Only?**

See: "One Speaker Not Working" article - this may be a hardware issue.

---

### Article 2.3: Charging Problems

**Title:** Charging Problems
**Category:** Troubleshooting
**Tags:** charging, battery, power, troubleshoot
...
1. **Check magnetic connection** - Pins should snap firmly to contacts on temples
2. **Clean contacts** - Gently wipe temple contacts with dry cloth, clean cable pins too
3. **Try different power source** - Different USB port, wall adapter, or computer
4. **Inspect cable** - Look for damage, bent pins, fraying

**LED On But Won't Charge**

1. Leave plugged in for 30+ minutes
2. May be deeply discharged - needs time
3. Try different power adapter (5V/1A minimum)

**Won't Hold Charge**

- Full charge should last 6-8 hours of playback
- Battery degrades over time (normal after 1-2 years)
- If new and won't hold charge → file warranty claim
...
### Article 2.4: One Speaker Not Working

**Title:** One Speaker Not Working
**Category:** Troubleshooting
**Tags:** speaker, audio, one side, hardware, warranty

---

**Important Note**

Audio on only one side often indicates a hardware issue. Try these fixes first.

**Step 1: Factory Reset**

Hold BOTH buttons for 10 seconds. Re-pair with phone and test.

**Step 2: Check Audio Balance**

Phone Settings → Accessibility → Audio Balance. Make sure slider is centered.

**Step 3: Test with Different Audio**

Try music, calls, and videos. Is it always the same side?

**Step 4: Update Firmware**

Open Lucyd app → Check for updates

**If Still One-Sided After Reset**

This is likely a hardware issue covered under warranty.

**To file a warranty claim:**
- Order number or proof of purchase
- Which side is affected (left/right)
- When the issue started
- Confirmation you've tried factory reset

We'll send a replacement pair!

---

### Article 2.5: App Issues

**Title:** Lucyd App Issues
**Category:** Troubleshooting
**Tags:** app, crash, troubleshoot
...
3. Update the app (App Store / Google Play)
4. Delete and reinstall app

**App Won't Find Glasses**

1. Make sure glasses are ON
2. Enable Bluetooth on phone
3. Enable Location Services (required for Bluetooth scanning)
4. Put glasses in pairing mode (hold button 5 sec)

**App Won't Connect to Glasses**

1. Ensure glasses are paired in phone Bluetooth settings first
2. Open app AFTER Bluetooth pairing complete
3. Grant all requested permissions

**Firmware Update Stuck**

1. Keep glasses close to phone
2. Keep glasses charged (50%+ recommended)
3. Don't close app during update
4. If stuck, force close app and retry
5. May need to factory reset and retry
...
### Article 2.6: Factory Reset Guide

**Title:** Factory Reset Guide
**Category:** Troubleshooting
**Tags:** reset, factory, troubleshoot
...
- After troubleshooting steps fail

**How to Factory Reset**

1. Make sure glasses are **ON** and **charged**
2. Press and hold **BOTH** temple buttons simultaneously
3. Keep holding for **10 seconds**
4. You'll hear a **confirmation tone**
5. Glasses will turn off and restart

**After Reset**

1. Glasses return to factory settings
2. Go to phone Bluetooth → Forget "Lucyd"
3. Put glasses in pairing mode (hold 5 sec)
4. Pair fresh with your phone
5. Reconnect in Lucyd app

**Reset Didn't Work?**

- Make sure you're pressing BOTH buttons
- Hold for full 10 seconds
- Ensure glasses have battery charge
- If no response at all → may need to charge first

---

## Category 3: 📦 Orders & Shipping

### Article 3.1: Track My Order
...
1. Check email for "Your Lucyd Order Has Shipped"
2. Click the tracking link in that email
3. Or log in at lucyd.co → Order History

**Tracking Status Meanings**

| Status | Meaning |
|--------|---------|
| Label Created | Shipment prepared, not yet picked up |
| In Transit | On the way! |
| Out for Delivery | Arriving today |
| Delivered | Check front door, mailbox, neighbors |

**No Tracking Email?**

- Check spam/promotions folder
- Order may still be processing (1-3 days)
- Prescription orders: 10-15 days before shipping

**Need Help?**

Contact us with your order number and we'll look it up!

---

### Article 3.2: Shipping Times
...
- Express: 2-3 business days (if available at checkout)

**Possible Delays**

- Weather events
- Carrier volume (holidays)
- Remote locations
- Prescription verification issues

We'll email you with any delays!

---

### Article 3.3: International Shipping
...
*Prescription orders add 7-10 additional days*

**Customs & Duties**

- Buyer responsible for import duties/taxes
- Customs may cause additional delays
- Value declared = purchase price

**Country Not Listed?**

Contact us - we may be able to arrange shipping to your location.

---

### Article 3.4: Change or Cancel Order

**Title:** Change or Cancel Order
**Category:** Orders & Shipping
**Tags:** cancel, change, modify

---

**Important: Orders Process Quickly!**

We can only modify orders that haven't shipped yet.

**Within 2 Hours of Ordering**

Best chance for changes. Contact us immediately with:
- Order number
- What you need changed

**After 2 Hours / Already Shipped**

**To Cancel:**
- Refuse delivery (returns automatically)
- Accept and request return label

**To Change Address:**
- Contact carrier directly with tracking number
- Some carriers allow redirect for a fee

**To Change Item:**
- Process as exchange after delivery

**How to Request Change**

Contact us ASAP with:
- Order number
- Change needed
- "URGENT" in subject
...
### Article 3.5: Order Not Received

**Title:** Order Not Received
**Category:** Orders & Shipping
**Tags:** missing, lost, delivery
...
- [ ] Check all doors, porches, mailbox
- [ ] Ask neighbors or building manager
- [ ] Look for delivery photo in tracking
- [ ] Check if someone else accepted it

**Tracking Shows "Delivered" But Can't Find**

1. Wait 24 hours (sometimes marked early)
2. Check with household members
3. Contact carrier with tracking number
4. File claim with us after 48 hours

**Tracking Shows "In Transit" Too Long**

| Situation | Action |
|-----------|--------|
| 7+ days in transit (domestic) | Contact us |
| 14+ days (international) | Contact us |
| "Exception" or "Delay" status | Wait 2-3 days, then contact |

**Package Lost**

If confirmed lost, we'll either:
- Reship your order, OR
- Issue full refund
...
### Article 4.1: How to Submit Prescription

**Title:** How to Submit Your Prescription
**Category:** Prescriptions
**Tags:** prescription, submit, Rx

---

**3 Easy Ways to Submit**

**Option 1: Upload at Checkout** ⭐ Fastest

1. Select prescription lenses
2. Choose "Upload Prescription"
3. Take photo or upload file
4. Or enter values manually

**Option 2: Email After Ordering**

1. Complete your order
2. Email prescription to: info@lucyd.co
3. Subject: "Rx for Order #[YOUR ORDER NUMBER]"
4. Attach clear photo of prescription

**Option 3: We Contact Your Doctor**

1. During checkout, select "Call My Doctor"
2. Enter doctor/practice name and phone
3. We'll request your Rx directly
...
### Article 4.2: PD Measurement Guide

**Title:** PD (Pupillary Distance) Measurement Guide
**Category:** Prescriptions
**Tags:** PD, pupillary distance, measure

---

**What is PD?**

PD (Pupillary Distance) is the distance between your pupils in millimeters. It's essential for positioning your lenses correctly.

**Average PD:** 57-72mm for adults

**Method 1: Lucyd App** ⭐ Easiest

1. Download Lucyd app
2. Open "Measure PD" feature
3. Hold credit card to forehead (for scale)
4. Look at camera
5. App calculates automatically

**Method 2: Mirror + Ruler**

1. Stand 8 inches from mirror
2. Hold mm ruler against brow
3. Close RIGHT eye
4. Align 0mm with center of LEFT pupil
5. Close LEFT eye, open RIGHT
6. Read number at center of RIGHT pupil
7. That's your PD!

**Method 3: Ask Your Doctor**

Call your eye doctor - they have it on file from your exam.

**Method 4: From Old Glasses**

A local optician can measure PD from your existing glasses.

**Single vs Dual PD**

- Single PD: One number (e.g., 63)
- Dual PD: Two numbers (e.g., 31/32)

Either works!

---

### Article 4.3: Prescription Requirements

**Title:** Prescription Requirements & Limits
**Category:** Prescriptions
**Tags:** prescription, limits, range
...
| Value | Range |
|-------|-------|
| SPH (Sphere) | -8.00 to +8.00 |
| CYL (Cylinder) | -4.00 to +4.00 |

**Progressive/Bifocal:**
| Value | Range |
|-------|-------|
| SPH (Sphere) | -6.00 to +6.00 |
| CYL (Cylinder) | -3.00 to +3.00 |
| ADD | up to +3.00 |
...
| Type | Best For |
|------|----------|
| Clear | Everyday indoor use |
| Blue Light Filter | Screen time, computer work |
| Photochromic | Indoor/outdoor transitions |
| Polarized | Driving, outdoors, water |
...
Contact us - we may have custom options available.

---

### Article 4.4: Prescription Processing Time

**Title:** Prescription Processing Time
**Category:** Prescriptions
**Tags:** processing, time, Rx order
...
1. ✓ Order confirmed
2. ✓ Prescription received
3. ✓ Lenses in production
4. ✓ Order shipped + tracking

**Why So Long?**

Prescription lenses are custom-made:
- Cut to your exact prescription
- Fitted to your chosen frame
- Multiple quality checks

**Need It Faster?**

Express options may be available - contact us to check. Rush fees may apply.

---

### Article 4.5: Vision Problems with New Glasses

**Title:** Vision Problems with New Glasses
**Category:** Prescriptions
**Tags:** vision, adjustment, blur

---

**Adjustment Period is Normal!**

New prescription lenses need 1-2 weeks to adjust.

**Normal During Adjustment**

- Mild headaches
- Slight eye strain
- Edges seem distorted
- Depth perception feels off
- Progressives: Finding "sweet spots"

**Tip:** Wear consistently - don't switch with old glasses
...
- Rx values entered incorrectly
- Your prescription changed

**We'll make it right!**

If our error, free remake. Contact us with your order number.

---

## Category 5: ↩️ Returns & Exchanges

### Article 5.1: Return Policy
...
✅ Free return shipping (we send label)

**Prescription Glasses**

⚠️ **Lenses are non-refundable** (custom-made)

However:
- Frame exchange available
- Vision issues → Free lens remake
...
### Article 5.2: How to Start a Return

**Title:** How to Start a Return
**Category:** Returns & Exchanges
**Tags:** return, start, label
...
1. **Request Return Label** - Contact us with order number, we'll email prepaid USPS label

2. **Pack Your Return** - Use original box if possible, include all accessories

3. **Ship It** - Attach label to package, drop at any USPS location, keep receipt

4. **Get Refund** - Processed within 5-7 days of receipt, returns to original payment

**Track Your Return**

Use the tracking number from the label at usps.com

---

### Article 5.3: How to Start an Exchange

**Title:** How to Start an Exchange
**Category:** Returns & Exchanges
...
1. **Contact Us** - Provide order number and what you want to exchange for

2. **Receive Return Label** - We'll email prepaid shipping label

3. **Ship Current Pair** - Send back within 14 days

4. **Receive New Pair** - We ship as soon as we receive return (or immediately if in stock)
...
We can help! Contact us with your face shape or a photo.

---

### Article 5.4: Refund Timeline
...
| Step | Time |
|------|------|
| Package delivered to us | Day 0 |
| Inspection & processing | 1-2 business days |
| Refund issued | 3-5 business days |
| Appears in account | 3-5 business days |

**Total: 7-12 business days from delivery**
...
- Shop Pay → Original payment

**Tracking Your Refund**

1. Watch for email: "Your refund has been processed"
2. Check bank/card statement
3. Allow full 5 business days for bank processing

**It's Been Too Long?**

If 14+ days since return delivered, contact us with return tracking and we'll investigate.

---

## Category 6: 🛡️ Warranty

### Article 6.1: Warranty Coverage
...
- Send replacement pair
- You return defective item after receiving replacement
- Free shipping both ways

---

### Article 6.2: How to File a Warranty Claim

**Title:** How to File a Warranty Claim
**Category:** Warranty
**Tags:** warranty, claim, file
...
Fill out support request with "Warranty Claim"

**Option 2: Email**

Send to info@lucyd.co with subject "Warranty Claim - Order #XXXXX"
...
1. We review (1-2 business days)
2. If approved, we ship replacement
3. Return defective pair with prepaid label

---

### Article 6.3: Out of Warranty Options

**Title:** Out of Warranty Options
**Category:** Warranty
**Tags:** warranty, expired, options

---

**Your warranty has expired, but we can still help!**

**Option 1: Discounted Replacement**

Loyal customer pricing on new glasses. Contact us for current offers.

**Option 2: Paid Repair**

Some issues can be repaired for a fee. Send details and we'll quote.

**Option 3: Replacement Parts**
...
Ask about trade-in programs when upgrading to new Lucyd glasses.
...
## Category 7: 🛒 Product Info

### Article 7.1: FSA/HSA Eligibility

**Title:** FSA/HSA Eligibility
**Category:** Product Info
**Tags:** FSA, HSA, insurance, payment

---

**Are Lucyd Glasses FSA/HSA Eligible?**

✅ **YES** - Prescription Lucyd glasses qualify!

**How to Use FSA/HSA**

**Option 1: Pay Directly**

Use your FSA/HSA debit card at checkout

**Option 2: Reimbursement**

Pay with regular card, submit receipt to your provider

**What Qualifies**

| Item | FSA/HSA Eligible |
|------|------------------|
| Rx frames + lenses | ✅ Yes |
| Non-Rx frames only | ❌ Usually No |
| Lens add-ons (blue light) | ✅ If with Rx |

**Need Itemized Receipt?**

We provide itemized receipts showing:
- Frames
- Prescription lenses
- Lens options

Contact us after purchase for receipt.

---

### Article 7.2: Frame Sizing Guide

**Title:** Frame Sizing Guide
**Category:** Product Info
**Tags:** sizing, fit, size

---

**Lucyd Sizes**

| Size | Face Width | Temple Length |
|------|------------|---------------|
| Small | 130-135mm | 140mm |
| Medium | 136-142mm | 145mm |
| Large | 143-150mm | 150mm |

**Medium fits most adults!**

**How to Measure**

**From Current Glasses:**

Look inside the temple for numbers like: 52-18-140
- 52 = Lens width
- 18 = Bridge width
- 140 = Temple length

Face width = Lens + Bridge + Lens
Example: 52 + 18 + 52 = 122mm

**No Glasses to Measure?**

- Measure face at widest point (cheekbones)
- Or use a credit card:
  - Card = 86mm wide
  - Face 1.5 cards wide = Small
  - Face 1.6 cards wide = Medium
  - Face 1.7+ cards wide = Large

**Still Unsure?**

Contact us with a photo and we'll recommend!

---

### Article 7.3: Phone Compatibility

**Title:** Phone Compatibility
**Category:** Product Info
**Tags:** compatibility, phone, iPhone, Android
...
Older phone? Contact us to verify.

---

### Article 7.4: Battery & Charging Specs

**Title:** Battery & Charging Specs
**Category:** Product Info
**Tags:** battery, charging, specs
...
|------|--------|
| Full Charge | ~1.5 hours |
| Quick Charge | 15 min = 2 hrs playback |
| Connector | Magnetic pins |

**Charging Tips**

- Use any USB power source (5V/1A minimum)
- Magnetic cable snaps to temple contacts
...
- Stay close to phone (reduces power)
- Turn off when not in use
- Avoid extreme temperatures

---

### Article 7.5: Water Resistance

**Title:** Water Resistance Rating
**Category:** Product Info
**Tags:** water, IPX4, sweat, rain

---

**IPX4 Rating**

Your Lucyd glasses are splash-resistant!
...
Not covered under warranty. Keep away from heavy water exposure!
